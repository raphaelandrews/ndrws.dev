...
Now let's install the DropdownMenu component and activate the sorting - components/poke-table/data-table-column-header.tsx 
...
Install the Toast component and add the Row Actions - components/poke-table/data-table-row-actions.tsx 
...
Add the pagination with the data-table-pagination.tsx
